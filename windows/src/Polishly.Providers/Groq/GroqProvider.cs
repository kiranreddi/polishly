...
namespace Polishly.Providers.Groq;
...
public class GroqProvider : IAiProvider
{
        ...
        [EnumeratorCancellation] CancellationToken ct = default)
    {
        ...
        {
            throw new HttpRequestException("Groq API key is missing or empty.", null, HttpStatusCode.Unauthorized);
        }
        ...
        {
            throw new HttpRequestException("401 Unauthorized: Invalid Groq API key.", null, HttpStatusCode.Unauthorized);
        }

        if (response.StatusCode == HttpStatusCode.TooManyRequests)
        {
            throw new HttpRequestException("429 Too Many Requests: Groq rate limit exceeded.", null, HttpStatusCode.TooManyRequests);
        }
