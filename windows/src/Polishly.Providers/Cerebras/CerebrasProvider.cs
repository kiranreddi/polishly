...
namespace Polishly.Providers.Cerebras;
...
public class CerebrasProvider : IAiProvider
{
        ...
        [EnumeratorCancellation] CancellationToken ct = default)
    {
        ...
        {
            throw new HttpRequestException("Cerebras API key is missing or empty.", null, HttpStatusCode.Unauthorized);
        }
        ...
        {
            throw new HttpRequestException("401 Unauthorized: Invalid Cerebras API key.", null, HttpStatusCode.Unauthorized);
        }

        if (response.StatusCode == HttpStatusCode.TooManyRequests)
        {
            throw new HttpRequestException("429 Too Many Requests: Cerebras rate limit exceeded.", null, HttpStatusCode.TooManyRequests);
        }
